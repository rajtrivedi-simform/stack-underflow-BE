...
export class CreateStartupDto {
  @ApiProperty() @IsString() startupName: string;
  ...
  @ApiProperty() @IsString() startupStage: string;
  @ApiProperty() @IsString() startupDescription: string;
  ...
  @ApiProperty({ example: '< 10 Lakh' }) @IsString() investmentRaised: string;
  @ApiProperty({ example: 'Bootstrapped' }) @IsString() investmentType: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsInt() @Min(0) coFounders?: number;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() dpiitNumber?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() investors?: string;
